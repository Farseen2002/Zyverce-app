...
const TestimonialCard = ({
    ...
    layout = false,
    onCardClose = () => { },
    backgroundImage = "https://images.unsplash.com/photo-1627398242454-45a1465c2479?q=80&w=2674&auto=format&fit=crop",
}: {
    testimonial: iTestimonial;
    index: number;
    layout?: boolean;
                    ...
                    <div className="fixed inset-0 h-screen overflow-hidden z-50">
                        ...
                        >
                            ...
                            <motion.p
                                ...
                                className="px-0 md:px-20 text-[rgba(31, 27, 29, 0.7)] text-lg font-thin font-serif underline underline-offset-8"
                            >
                                {testimonial.designation}
                            </motion.p>
                            <motion.p
                                layoutId={layout ? `title-${testimonial.name}` : undefined}
                                className="px-0 md:px-20 text-2xl md:text-4xl font-normal italic text-[rgba(31, 27, 29, 0.7)] mt-4 font-serif lowercase"
                            >
                                {testimonial.name}
                            </motion.p>
    ...
    const coursesData = [
        {
            ...
            description: "Master Python from basics to advanced. Ideal for AI and Data Science careers.",
            profileImage: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=1974&auto=format&fit=crop"
        },
        {
            name: "Web Development",
            designation: "Software",
            description: "Build modern websites using HTML, CSS, JavaScript, and React.",
            profileImage: "https://images.unsplash.com/photo-1547658719-da2b51169166?q=80&w=2664&auto=format&fit=crop"
        },
        {
            name: "Flutter App Dev",
            designation: "Mobile",
            description: "Create beautiful cross-platform mobile apps with Flutter.",
            profileImage: "https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?q=80&w=2670&auto=format&fit=crop"
        }
    ];

    return (
        <div className="py-20 bg-white">
            <h2 className="text-4xl md:text-5xl font-bold text-center text-black mb-10">Our Courses</h2>
            <Carousel
                items={coursesData.map((course, index) => (
                    <TestimonialCard
                        key={index}
                        testimonial={course}
                        index={index}
