...
export function Products() {
    return (
        <div className="py-20 flex flex-col justify-center items-center bg-neutral-900 text-white min-h-[70vh]">
            <h2 className="text-4xl md:text-6xl font-bold text-center mb-10">Our Products</h2>
